...
rem
rem -Xrunjvm_profiler: Run the virtual machine profiler (jvm_profiler.dll).
rem
...
set VMARGS=-Xrunjvm_profiler -Xms8m -Xmx512m -classpath samiam.jar;inflib.jar edu.ucla.belief.ui.UI
