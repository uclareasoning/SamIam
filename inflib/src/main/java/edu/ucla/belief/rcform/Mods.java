...
public class Mods
{
	...
	public Mods(List<Term> terms)
	{
		...
		if (terms.size() > 0)
		{
			...
			for (Term t: terms)
			{
				...
				assert (Arrays.equals(t.getVarBits(), var_bits)) : "Can't construct Mods: Not all terms over same variables"; 
	 ...
	 */
	public static Mods project(Mods f, int[] proj_var_bits)
	{	
		...
		Mods result = new Mods(new ArrayList<Term>(model_set));
	...
	public boolean equals(Object obj)
	{
		...
		boolean result = models.equals(((Mods)obj).models);
