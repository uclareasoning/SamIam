...
@rem      keith cascio 20060315 (UCLA Automated Reasoning Group)
@rem **********************************************************************
@rem
...
rem --------------------------
set programOutput=jvm_profiler.dll
set defaultOS=win32
...
:MAKE_ALL
echo Building %OS% JVMPI access JNI DLL. Defaults: -os %DEFAULT_OS% -arch %DEFAULT_OS_ARCH% -ws %DEFAULT_WS%
